...
Proof.
  ...
  - destruct n. simpl in H. 
    + apply H.  
    + rewrite -> plus_comm in H. rewrite <- plus_n_Sm in H. inversion H. Qed.
(** [] *)
...
Proof.
  ...
  - left. reflexivity.
  - right. simpl in H. apply and_exercise in H.
    apply proj1 in H. apply H. Qed.
(** [] *)
...
Fact not_implies_our_not : forall (P:Prop),
  ~ P -> (forall (Q:Prop), P -> Q).
Proof.
  intros. apply ex_falso_quodlibet. apply H. apply H0. Qed.
(** [] *)
...
Theorem contrapositive : forall (P Q : Prop),
  (P -> Q) -> (~Q -> ~P).
Proof.
  intros P Q H HQ. unfold not. unfold not in HQ. 
  intros HP. apply H in HP. apply HQ in HP. apply HP. Qed.
(** [] *)
...
Proof.
  ...
  inversion H2. apply H in H1. inversion H1.
Qed. 
(** [] *)
