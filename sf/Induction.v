...
(* One extra (induction) hypothesis *)
*)
(** [] *)
...
Proof.
  ...
  - simpl. rewrite -> IHm. rewrite ->mult_distr. reflexivity. Qed.
(** [] *)
...
Theorem nat_validation : forall n:nat,
...
Theorem bin_validation : forall b:bin,
