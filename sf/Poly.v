...
Lemma map_app : forall (X Y : Type) (f : X -> Y) (l m : list X),
...
Proof.
  intros. induction l.
  - simpl. reflexivity.
  - simpl. rewrite <- IHl. rewrite -> map_app. reflexivity.  Qed.
(** [] *)
...
Definition increment_if_true (b : bool) (n : nat) : nat := 
  match b with
    | true => S n
    | false => n
  end.
...
Example fold_counttrue :
  fold increment_if_true  [true; false; true; false] O = 2.
Proof. reflexivity. Qed.
(** [] *)
