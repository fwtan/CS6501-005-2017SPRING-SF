...
Inductive natlistprod : Type :=
  list_pair : natlist -> natlist -> natlistprod.

Notation "( x , y )" := (list_pair x y).
...
Theorem bag_theorem : forall (v:nat) (b1 b2 :bag), 
...
Proof.
  destruct x. simpl. rewrite <- beq_nat_refl. reflexivity. Qed.
(** [] *)
...
Proof.
  intros d x v. 
  simpl. destruct x. simpl. rewrite <- beq_nat_refl. reflexivity. Qed.
(** [] *)
